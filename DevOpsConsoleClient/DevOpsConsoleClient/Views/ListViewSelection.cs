...
namespace Terminal.Gui
{
    ...
    /// </summary>
    public interface IListDataSources
    {
        /// <summary>
        ...
        /// </remarks>
        void Render(ListViewSelection container, ConsoleDriver driver, bool selected, int item, int col, int line, int width);
    ...
    /// </para>
    /// </remarks>
    public class ListViewSelection : View
    {
        private int top;
        ...
        // IList instances
        //
        private class ListWrapper : IListDataSources
        {
            private IList src;
            ...
            public void Render(ListViewSelection container, ConsoleDriver driver, bool marked, int item, int col, int line, int width)
            {
        ...
        private static IListDataSources MakeWrapper(IList source)
        {
        ...
        public ListViewSelection(IList source) : this(MakeWrapper(source))
        {
        }
        ...
        public ListViewSelection(IListDataSources source) : base()
        {
            Source = source;
            CanFocus = true;
        }
        ...
        /// <param name="source">An IList data source, if the elements of the IList are strings or ustrings, the string is rendered, otherwise the ToString() method is invoked on the result.</param>
        public ListViewSelection(Rect rect, IList source) : this(rect, MakeWrapper(source))
        {
        }
        ...
        /// <param name="rect">Frame for the listview.</param>
        /// <param name="source">IListDataSource object that provides a mechanism to render the data. The number of elements on the collection should not change, if you must change, set the "Source" property to reset the internal settings of the ListView.</param>
        public ListViewSelection(Rect rect, IListDataSources source) : base(rect)
        {
            Source = source;
            CanFocus = true;
        }
